...
public class LoggerUtils {
    ...
    public static void error(String position, String method, String content) {
        ...
        if (errorLevel()) {
            getLogger().error(toMessage(Thread.currentThread().getId(), position, method, content));
        }
    }
    ...
    public static void error(String position, String method, Throwable t) {
        ...
        if (errorLevel()) {
            getLogger().error(toMessage(Thread.currentThread().getId(), position, method, ""), t);
        }
    }
    ...
    public static void warn(String position, String method, String content) {
        ...
        if (warnLevel()) {
            getLogger().warn(toMessage(Thread.currentThread().getId(), position, method, content));
        }
    }
    ...
    public static void info(String position, String method, String content) {
        ...
        if (infoLevel()) {
            getLogger().info(toMessage(Thread.currentThread().getId(), position, method, content));
        }
    }
    ...
    public static void debug(String position, String method, String content) {
        ...
        if (debugLevel()) {
            getLogger().debug(toMessage(Thread.currentThread().getId(), position, method, content));
        }
    }
    ...
    private static String toMessage(long id, String position, String method, String content) {
        return "[" + id + "][" + position + "]" + "\n" + "方法：" + method + "\n" + "参数：" + content + "\n";
    }
